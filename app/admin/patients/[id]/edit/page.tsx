...
// ✅ การแก้ไข:
//    1. แสดงข้อมูลจังหวัด อำเภอ ตำบล รหัสไปรษณีย์ ก่อนช่อง dropdown
//    2. สามารถแก้ไขเลขบัตรประชาชนได้
//    3. บันทึกเลขบัตรประชาชนกลับไปที่ users table
'use client';
...
export default function EditPatientPage() {
  ...
  const validateIdCard = (idCard: string): { valid: boolean; message: string } => {
    ...
    // ✅ ตรวจสอบ checksum ตามอัลกอริทึมบัตรประชาชนไทย
    let sum = 0;
    for (let i = 0; i < 12; i++) {
              ...
              {addressData.province && (
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                  ...
                  <div className="text-sm text-blue-700 space-y-1">
                    ...
                    <p><strong>อำเภอ/เขต:</strong> {addressData.district || '-'}</p>
                    <p><strong>ตำบล:</strong> {addressData.subdistrict || '-'}</p>
                    <p><strong>รหัสไปรษณีย์:</strong> {addressData.postalCode || '-'}</p>
                  </div>
                </div>
              )}
