// app/admin/patients/[id]/screening/page.tsx
'use client';
  ...
  const calculatePatientLevel = () => {
    ...
    if (pamTotal <= 5) {
      return {
        ...
        pamTotal, pamAvg, pamMax, promsTotal, promsAvg, promsMax, promsMin,
        priority: 'high',
    ...
    try {
      ...
      if (result.success) {
        ...
        if (confirmGoToGoals) {
          ...
          router.push(`/admin/patients/${patientId}/screening-history`);
        }
      } else {
      ...
      <div className="bg-white/80 backdrop-blur-sm border-b border-white/50 shadow-sm">
        <div className="max-w-5xl mx-auto px-4 py-6">
          ...
          >
            ...
            <span>กลับหน้าประวัติการประเมิน</span>
          </button>
