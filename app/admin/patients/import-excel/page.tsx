...
export default function ImportExcelPage() {
  ...
  // ✅ ฟังก์ชัน Export Excel แบบละเอียด (เพิ่มข้อมูลโค้ช)
  const handleExportToExcel = () => {
    ...
    const exportData = sortedData.map((row, idx) => {
      ...
      // ✅ หาชื่อโค้ชจาก coach_id หรือ coach_name
      let coachName = '-';
      let coachHospital = '-';
    ...
    wsAll['!cols'] = [
      ...
      { wch: 10 }, { wch: 15 }, { wch: 10 }, { wch: 10 }, { wch: 30 }, { wch: 25 },
      { wch: 25 }, { wch: 15 }, { wch: 40 }, { wch: 15 }, { wch: 10 }
    ];
    ...
    summary.push(['ลำดับ', 'เลขบัตร', 'ชื่อ-นามสกุล', 'HN', 'โค้ช', 'ข้อผิดพลาด']);
    ...
    wsSummary['!cols'] = [
      { wch: 10 }, { wch: 20 }, { wch: 30 }, { wch: 15 }, { wch: 25 }, { wch: 40 }
    ];
