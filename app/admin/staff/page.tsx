...
// ✅ การแก้ไขรอบนี้:
//    1. ✅ ลบปุ่ม "แก้ไขเลขบัตร" (Shield) ออกจากตาราง
//    2. ✅ เพิ่มช่อง "ID Card" ในหน้าแก้ไข (Edit Modal) เพื่อให้แก้เป็นปกติได้
//    3. ✅ คงปุ่มแก้ไขและลบไว้ตามเดิม
// =====================================================
'use client';
                      ...
                      {/* ✅ Badge บทบาท */}
                       ...
                       <td className="px-6 py-4">
                         <div className="flex items-center gap-2">
                          {canEdit ? (
                             <>
                              {/* ❌ เอาปุ่ม Shield/Verify ออกแล้ว ตามคำขอ */}
